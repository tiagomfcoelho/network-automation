...
# Filter by group
python3 connect_routers.py --group routers

# Custom command
python3 connect_routers.py --group routers --command "show version"

# Different site
python3 connect_routers.py --site Lab-CCNP --command "show ip route"
```
...
python3 connect_routers.py --group routers --command "show ip route"

# Show CDP neighbors on all devices
python3 connect_routers.py --command "show cdp neighbors"

# Show version on switches only
python3 connect_routers.py --group switches --command "show version"
```
